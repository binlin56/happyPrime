...
public class LogRequestResponseFilter implements ClientHttpRequestInterceptor {
    ...
    protected Logger requestLogger = LogManager.getLogger("spring.web.client.MessageTracing.sent");
    protected Logger responseLogger = LogManager.getLogger("spring.web.client.MessageTracing.received");
